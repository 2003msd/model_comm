...
specAn1 = spectrumAnalyzer("SampleRate", Fs, "Method","Filter bank","AveragingMethod","Exponential","Title", "PSD for transmitter filter o/p");
...
%%
 ...
 %%
 specAn2 = spectrumAnalyzer("SampleRate", Fs, "Method","Filter bank","AveragingMethod","Exponential","Title", "PSD for modulated signal");
 specAn2(p3_with);
 %%
 ...
 %%
 specAn3 = spectrumAnalyzer("SampleRate", Fs, "Method","Filter bank","AveragingMethod","Exponential","Title", "PSD for demodulated signal");
 specAn3(tx_output_filtered);
 %%
